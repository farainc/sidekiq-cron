  ...
  module Cron
    ...
    class Poller < Sidekiq::Scheduled::Poller
      ...
      def enqueue
        ...
        logger.warn "[#{time}] [#{current_process_pid}] enqueueable jobs size: (#{enqueueable_jobs.size})"
      rescue => ex
      ...
      def calculate_safe_enqueue_interval(now, interval)
        ...
        logger.warn "[#{current_process_pid}] ensure_safe_enqueue_interval override, calculated interval: (#{interval})"
