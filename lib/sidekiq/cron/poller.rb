  ...
  module Cron
    ...
    class Poller < Sidekiq::Scheduled::Poller
      ...
      def enqueue
        ...
        logger.info "CRON JOB: current_locktime skipped? [#{current_locktime > timestamp}] (#{current_locktime} > #{timestamp})"
        ...
        logger.info "CRON JOB: unique_locktime skipped? [#{unique_locktime > timestamp}] (#{unique_locktime} > #{timestamp})"
